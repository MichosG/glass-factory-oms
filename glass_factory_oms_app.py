...
def main_app(user_role):
    ...
    xlsx_data = export_excel(st.session_state.orders)
    st.download_button("📊 Download Excel", data=xlsx_data, file_name="orders.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
